from vectersearch import hybrid_search
from vectersearch import modify_query
...
def generate_word_storyboard(message):
    query = modify_query(message)
